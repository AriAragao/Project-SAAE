...
<body>
	...
	<div id="DivCorpo">
        ...
        <a href="pgCadProfessor.php"> <button> Cadastrar</button></a>
        ...
        <tbody>
            ...
            $query = mysqli_query($link,"SELECT * FROM professor");
            
            while ($line=mysqli_fetch_assoc($query)) { ?>
            <tr>
                <td><?php echo $line['id']; ?></td>
                <td><?php echo $line['nomeProf']; ?></td>
                <td><?php echo $line['emailProf']; ?></td>
                <td><?php echo $line['areaProf']; ?></td>
            
                
                <td><a href="UpDelProfessor.php"><img src="img/latLixo.png" id="ExcluirCurso"> <img src="img/editar.png" id="EditarCurso"></a></td>
